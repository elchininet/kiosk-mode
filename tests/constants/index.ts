...
export const SELECTORS = {
	...
	SETTINGS: 'ha-md-list-item.configuration',
	NOTIFICATIONS: 'ha-md-list-item.notifications',
	ACCOUNT: 'ha-md-list-item.user',
	ADD_TO_HOME_ASSISTANT: 'ha-dropdown > ha-icon-button[data-selector="ADD"]',
	SEARCH_BUTTON: 'ha-icon-button[data-selector="SEARCH"]',
	ASSISTANT_BUTTON: 'ha-icon-button[data-selector="ASSIST"]',
	OVERFLOW_BUTTON: 'ha-dropdown > ha-icon-button[data-selector="OVERFLOW"]',
	MENU_REFRESH_ITEM: 'ha-dropdown-item[data-selector="REFRESH"]',
...
export const DIALOGS_SELECTORS = {
	...
	MEDIA_ACTIONS_MAIN: '.bottom-controls > .main-controls',
	MEDIA_ACTIONS_SECONDARY: '.bottom-controls > .controls-row',
...
export const ENTITIES = {
	...
	HIDE_SETTINGS: 'kiosk_hide_settings',
